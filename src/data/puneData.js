...
export const places = [
  {
    ...
    bgColor: "#F2EAE7",
    description:
      "Shaniwar Wada was the seat of the Peshwa rulers of the Maratha Empire. Built in 1730, this majestic fortification once housed the most powerful rulers of 18th-century India, featuring grand gates and towering bastions.",
  },
  {
    id: 2,
    ...
    bgColor: "#EDE8DF",
    description:
      "The most celebrated Ganesh temple in Pune, over 130 years old and standing at the heart of the city. The idol is adorned with gold and the temple draws millions of devotees every year.",
  },
  {
    id: 3,
    ...
    bgColor: "#EBF0E8",
    description:
      "Spread across the Katraj hills, this wildlife sanctuary houses over 35 species including leopards, pythons, and exotic birds. It also has a snake park and a rescue center.",
  },
  {
    id: 4,
    ...
    bgColor: "#FDF3E0",
    description:
      "The artery of Pune's youth culture and culinary soul. Vada pav, missal pav, cutting chai, and Irani café biscuits line every block. Fergusson College Road is the city's most beloved food street.",
  },
  {
    id: 5,
    ...
    bgColor: "#ECEAF8",
    description:
      "Built in 1892, this stunning palace served as the detention site for Mahatma Gandhi and his wife Kasturba during the Quit India Movement. It now houses a Gandhi memorial museum.",
  },
  {
    id: 6,
